#!/usr/bin/env python3
"""
Download a specific file from a match using the RallyHere Files API.
"""
import os
import requests
...
FILE_NAME = "CombatLog_60ce5622-4b06-44f3-8663-0030d6c23d11.log"
...
# Based on our exploration, this should be the direct file access URL
